...
//       </div>
//       <div className="w-[100%] md:w-[50%] h-[100%]">
//         <div className="bg-gray-700 h-[285px] md:h-[60%] rounded-md px-4  mb-2 relative">
//           <Savings />
//         </div>
//         <div className="bg-gray-700 h-[150px] md:h-[38.5%] rounded-md px-4 relative">
//           <Budget />
//         </div>
//       </div>
//     </div>
...
export default function AddNew() {
  return (
    <div className="flex flex-col md:flex-row items-center gap-2  md:h-[100%]  mx-2  text-black mb-16 md:mb-0">
      <div className="w-[100%] md:w-[50%] h-[100%]">
        <div className="bg-gray-700 h-[125px] md:h-[25%] px-4 flex flex-col gap-y-2 rounded-md relative mb-2 ">
          <Amount />
        </div>
        <div className="bg-gray-700 h-[390px] md:h-[73.6%] px-4 flex flex-col gap-y-2 rounded-md relative ">
          <Transaction />
        </div>
      </div>
      <div className="w-[100%] md:w-[50%] h-[100%]">
        <div className="bg-gray-700 h-[207px] md:h-[38.5%] rounded-md px-4 relative mb-2">
          <Budget />
        </div>
        <div className="bg-gray-700 h-[320px] md:h-[60%] rounded-md px-4  relative">
          <Savings />
        </div>
      </div>
    </div>
