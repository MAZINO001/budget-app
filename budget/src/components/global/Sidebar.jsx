...
export default function Sidebar() {
  ...
  return (
    <div className="md:w-[50px] lg:w-[150px] h-[45px] max-h-[592px] md:h-[100vh] flex flex-row md:flex-col justify-between  bg-gray-700  ml-2 mr-2 md:mr-0 mt-2 rounded-md stickySidebar">
      <Link
        to="/"
        className="flex items-center justify-center gap-2 md:ml-0 ml-2 md:mt-2"
      >
      ...
      <div
        className={`${
          isMobile
            ? "flex flex-row md:flex-col justify-between md:h-[350px] text-2xl cursor-pointer gap-14 mobileSidebar "
            : "flex flex-row md:flex-col justify-between md:h-[350px] text-2xl cursor-pointer gap-14 mx-2"
        }`}
      >
        <Link
          to="/"
      ...
      <Link
        to="/settings"
        className={`flex items-center lg:justify-start justify-center lg:ml-2 ml-0 mr-2 md:mr-0 gap-2 text-2xl cursor-pointer md:mb-2 ${
